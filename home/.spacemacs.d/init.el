...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(snakemake-mode ob-ipython yasnippet-snippets editorconfig interleave org-cliplink synonymous openwith pdf-tools dash
