...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(ob-ipython yasnippet-snippets editorconfig interleave org-cliplink synonyms)
   ...
   (quote
    (("b" "Buy (add to shopping list)
     ...
     ("a"               ; key
      "Article"         ; name
      entry             ; type
      (file+headline "~/wiki/papers.org" "Article")  ; target
