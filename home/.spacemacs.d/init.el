   ...
   (quote
    (((equal exwm-class-name "Rambox")
     ...
     ((equal exwm-class-name "URxvt")
      workspace 1)
     ((equal exwm-class-name "SnapGene Viewer")
      floating t)
