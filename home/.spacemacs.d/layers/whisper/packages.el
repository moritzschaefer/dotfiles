...
;; added to `whisper-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `whisper/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `whisper/pre-init-PACKAGE' and/or
;;   `whisper/post-init-PACKAGE' to customize the package as it is loaded.
